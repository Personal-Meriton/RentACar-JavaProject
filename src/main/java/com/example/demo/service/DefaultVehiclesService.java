...
public class DefaultVehiclesService implements VehiclesService {
    ...
    public Vehicles save(VehiclesInput vehicleInput) {
        ...
        Location newlocation=vehicleInput.getLocationid();
    ...
    public Vehicles update(Vehicles vehicle, VehiclesInput vehiclesInput) {
        ...
        Location updateLocation=vehiclesInput.getLocationid();
    ...
    @Override
    public List<Vehicles> findAvaliableVehicle(Date pdate, Date ddate , Integer location) {
        return vehiclesRepository.findAvaliableVehicle(pdate, ddate,location);
    }
