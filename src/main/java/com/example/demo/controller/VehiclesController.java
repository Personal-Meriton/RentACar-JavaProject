...
public class VehiclesController {
    ...
    @GetMapping("/vehicle/filter")
    //http://localhost:8080/note/filter?title=Java&notebookId=2
    public List<Vehicles> findAvaliableVehicle(@RequestParam Date pdate,
                                                    @RequestParam Date ddate, @RequestParam Integer location) {


        return vehiclesService.findAvaliableVehicle(pdate, ddate , location);
    }
