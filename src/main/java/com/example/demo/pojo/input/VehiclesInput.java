...
//    private Location location;
    ...
    public VehiclesInput(String brand, String model, Integer year, String ftype, String milage, Integer hp, String gear, String color, String plate, Float price ,Location locationid ) {
        this.brand = brand;
        this.model = model;
        this.year = year;
        this.ftype = ftype;
